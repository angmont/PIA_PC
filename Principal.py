...
if __name__ == "__main__":
  ...
  choices=['cifmensaje', 'desmensaje', 'cifgithub', 'desgithub', 'busqueda', 'emails', 'pdf', 'img'] , help='Si desea utilizar la tarea de cifrado/descifrado, es necesario especificiar el modo')
